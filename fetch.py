...
repositories = [
    ...
    "tomodachi-life-same-sex-relationships-and-non-binary-miis",
]
for repository in repositories:
    subprocess.run(
        ["git", "clone", f"https://github.com/pride-translators/{repository}"]
    )
os.chdir("..")
...
sexuality_docs = [
    ...
    Document(
        ...
        replacements=[
            (
                "./attachments",
                f"{path}/asexuality_is_finally_breaking_free_from_medical_stigma",
            )
        ],
    ...
    Document(
        ...
        replacements=[("./attachments", f"{path}/what_does_it_mean_to_be_asexual")],
...
other_docs = [
    Document(
        ...
        replacements=[("./attachments", f"{path}/the-coming-out-handbook")],
    ...
    Document(
        ...
        replacements=[("./attachments", f"{path}/flags-of-the-lgbtqia-community")],
    ...
    Document(
        source_file_directory="./documents/celeste-madeline-transgender-confirmed-important/README.md",
        destination_file_directory="./src/routes/documents/others/celeste-madeline-transgender-confirmed-important/+page.md",
        replacements=[
            (
                "./attachments",
                f"{path}/celeste-madeline-transgender-confirmed-important",
            )
        ],
    ...
    Document(
        ...
        replacements=[("./attachments", f"{path}/nodejs-lgbtqia-stories-emelia-smith")],
        attachment_folder_name="nodejs-lgbtqia-stories-emelia-smith",
    ),
    Document(
        source_file_directory="./documents/tomodachi-life-same-sex-relationships-and-non-binary-miis/README.md",
        destination_file_directory="./src/routes/documents/others/tomodachi-life-same-sex-relationships-and-non-binary-miis/+page.md",
        replacements=[("./attachments", f"{path}/tomodachi-life-same-sex-relationships-and-non-binary-miis")],
        attachment_folder_name="tomodachi-life-same-sex-relationships-and-non-binary-miis",
    ),
]
...
def move_documents(docs: list[Document]):
    for doc in docs:
        destination_path_directory = os.path.dirname(doc["destination_file_directory"])
...
def move_attachments(docs: list[Document]):
    for doc in docs:
        ...
        shutil.move(prev_attachment_folder_directory, new_attachment_folder_directory)
